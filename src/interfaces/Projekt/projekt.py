...
def create_new_project_structure():
    ...
    from src.interfaces.Office.Checkliste.checkliste import create_schema_checklist, create_pcb_checklist
    from src.interfaces.Office.Systembeschreibung.systembeschreibung import create_new_system_description

    project_folder_name = ask_input("Projektordnername",
    ...
    if project_dir.exists():
        console.print(f"[red]Projektordner existiert bereits![/red]")
        return
    ...
    if ask_yes_no("Schema Layout erstellen", "Möchten Sie ein Schema Layout im neuen Projekt erstellen?"):
        os.chdir(sl_dir)
    ...
    if ask_yes_no("Checklisten erstellen", "Möchten Sie Checklisten im neuen Projekt erstellen?"):
    ...
    if ask_yes_no("Obsidian Vault erstellen", "Möchten Sie einen Obsidian Vault im neuen Projekt erstellen?"):
    ...
    if ask_yes_no("Systembeschreibung erstellen", "Möchten Sie eine Systembeschreibung im neuen Projekt erstellen?"):
